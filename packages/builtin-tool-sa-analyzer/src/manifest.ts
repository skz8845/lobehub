...
**L3 3198违规远控**: 319801=TeamViewer, 319802=向日葵, 319803=ToDesk, 319804=RustDesk, 319805=AnyDesk, 319806=腾讯远程协助, 319807=百度远程控制, 319808=pcAnywhere, 319809=违规管理-Netman, 319810=X11 Forwarding
...
**L3 3101运维违规**: 310101=违规访问带外管理(KVM/IPMI)
...
**L3 3105飞行与特种作业违规**: 310501=飞行速度违规, 310502=飞行高度违规, 310503=禁飞区闯入
**L3 3106违规进程运行**: 310601=违规其他黑名单进程
**L3 3108资产配置违规**: 310803=一机多网卡, 310804=一网卡多IP, 310805=弱加密协议使用(TLS1.0/RC4), 310806=弱加密协议使用
...
**L3 3231 恶意程序与C2**: 323101=勒索软件通信, 323102=挖矿程序通信, 323103=DGA域名解析, 323104=僵尸网络/C2心跳, 323105=恶意文件传播, 323106=恶意指纹告警(JA3/HASSH), 323107=间谍软件, 323108=恶意工具, 323109=恶意程序
**L3 3232 隐蔽隧道**: 323201=DNS隧道, 323202=ICMP隧道, 323203=HTTP/HTTPS隐蔽通道, 323204=SSH隧道, 323205=L2TP/PPTP违规隧道, 323206=SOCKS代理违规搭建, 323207=可疑的SSL加密通道
...
**L3 3309 认证登录异常**: 330901=异地登录/非常用地点, 330902=非工作时间登录, 330903=频繁登录失败, 330904=同人不同终端, 330905=同终端多人, 330906=退休用户访问, 330907=外区域人员访问
**L3 3310 PKI证书**: 331001=PKI跨区域使用, 331002=PKI长期未拔出, 331003=一Key多机, 331004=一机多证, 331005=过期证书激活, 331006=PKI反复插拔, 331007=PKI证书长期未使用, 331008=离退休PKI被使用, 331009=离退休PKI未注销, 331010=僵尸证书使用, 331011=过期PKI使用, 331012=PKI证书弱口令
**L3 3311 数据查询**: 331101=查询应用超限, 331102=查询警员数量超限, 331103=非业务部门查询, 331104=查询频次突增, 331105=查询对象离散度过大, 331106=非业务时间高频查询, 331107=敏感人群定向查询, 331108=多人同时查询同一目标, 331109=查询年轻女性, 331110=公众人物查询, 331111=热点事件人物查询, 331112=被查询车辆离散度过大, 331113=查询女性占比过高, 331114=查询范围异常
**L3 3312 终端操作**: 331201=高频截屏/录屏, 331202=大量文件拷贝/打印, 331203=非工作时间访问异常, 331204=非授权文件分发/大流量传输, 331205=非工作时间高频操作
...
3501=物联网设备状态(350101=低电量告警, 350102=设备离线/心跳丢失), 3502=无人机飞行安全(350201=GPS信号丢失/漂移, 350202=前视避障传感器失效, 350203=后视/下视避障传感器失效, 350204=返航路径受阻, 350205=返航点精度不足, 350206=返航降落执行失败, 350207=强制降落触发, 350208=图传信号中断, 350209=遥控信号丢失, 350210=电机/电调异常)
