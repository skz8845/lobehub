...
export const getToolsConfig = () => {
  return createEnv({
    runtimeEnv: {
      ...
      CVE_MILVUS_URL: process.env.CVE_MILVUS_URL,
      CVE_MILVUS_DB_NAME: process.env.CVE_MILVUS_DB_NAME,
      CVE_MILVUS_COLLECTION_NAME: process.env.CVE_MILVUS_COLLECTION_NAME,
    ...
    server: {
      ...
      CVE_MILVUS_URL: z.string().url().optional(),
      CVE_MILVUS_DB_NAME: z.string().optional(),
      CVE_MILVUS_COLLECTION_NAME: z.string().optional(),
